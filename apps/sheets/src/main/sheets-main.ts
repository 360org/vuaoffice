...
const tMain = createI18n({
  ...
  vi: {
    ...
    filterXlsm: 'Sổ làm việc Excel kích hoạt Macro',
    ...
    errFileTooLarge: 'Tệp vượt quá kích thước tối đa',
    ...
    errImgBadType: 'Tệp này không phải là hình ảnh PNG/JPEG/GIF.',
    errDiskChanged:
      'Sổ làm việc đã bị thay đổi trên ổ đĩa sau khi mở — vui lòng sử dụng tính năng Lưu thành.',
    autosaveFoundTitle: 'Phát hiện phiên bản tự động khôi phục',
    autosaveFoundBody:
      'Phiên làm việc trước có các thay đổi chưa được lưu. Bạn có muốn khôi phục phiên bản tự động lưu không? Sau khi khôi phục, thao tác lưu sẽ ghi đè trực tiếp lên tệp gốc.',
    ...
    closeUnsavedDetail: 'Nếu đóng mà không lưu, những thay đổi này sẽ bị mất.',
