...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiNotLoggedIn: '未登录（AI 功能需要登录 VuaOffice 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginGenspark: '登录 VuaOffice',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiLoginGenspark: 'Sign in to VuaOffice',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiLoginGenspark: 'VuaOffice にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  fr: {
    ...
    aiLoginGenspark: 'Se connecter à VuaOffice',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  es: {
    ...
    aiLoginGenspark: 'Iniciar sesión en VuaOffice',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  th: {
    ...
    aiLoginGenspark: 'ลงชื่อเข้าใช้ VuaOffice',
    aiModel: 'โมเดล',
    aiCancel: 'ยกเลิก',
    aiSave: 'บันทึก',
  ...
  id: {
    ...
    aiLoginGenspark: 'Masuk ke VuaOffice',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
  ...
  ru: {
    ...
    aiLoginGenspark: 'Войти в VuaOffice',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiLoginGenspark: 'تسجيل الدخول إلى VuaOffice',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
  ...
  pt: {
    ...
    aiLoginGenspark: 'Entrar no VuaOffice',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  it: {
    ...
    aiLoginGenspark: 'Accedi a VuaOffice',
    aiModel: 'Modello',
    aiCancel: 'Annulla',
    aiSave: 'Salva',
  ...
  pl: {
    ...
    aiLoginGenspark: 'Zaloguj się do VuaOffice',
    aiModel: 'Model',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
  ...
  ms: {
    ...
    aiLoginGenspark: 'Log masuk ke VuaOffice',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
  ...
  hi: {
    ...
    aiLoginGenspark: 'VuaOffice में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    aiNotLoggedIn: '未登入（AI 功能需要登入 VuaOffice 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginGenspark: '登入 VuaOffice',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
