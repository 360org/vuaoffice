...
export const tMain = createI18n({
  ...
  id: {
    ...
    errGskNotLoggedIn: 'Belum masuk ke GenOffice: klik “Masuk ke Genspark” di bawah, lalu coba lagi',
  ...
  vi: {
    ...
    untitledDeck: 'Bản trình chiếu chưa đặt tên',
    autosaveFoundTitle: 'Phát hiện phiên bản tự động khôi phục',
    autosaveFoundBody: 'Phiên làm việc trước có các thay đổi chưa lưu. Bạn có muốn khôi phục phiên bản tự động lưu không?',
    autosaveRestore: 'Khôi phục',
    autosaveDiscard: 'Hủy bỏ',
    closeUnsavedMsg: 'Bản trình chiếu này có các thay đổi chưa được lưu.',
    closeUnsavedDetail: 'Bạn có muốn lưu trước khi đóng không?',
    btnDontSave: 'Không lưu',
    btnCancel: 'Hủy',
    mediaUnsupportedTitle: 'Video có thể không phát được trong ứng dụng',
    mediaNoAudioBody: 'Định dạng mã hóa âm thanh ({codec}) của video này không được trình phát tích hợp hỗ trợ, sẽ không có âm thanh khi phát trong ứng dụng. Tệp vẫn được nhúng nguyên vẹn và sẽ phát bình thường khi xuất ra PowerPoint.',
    mediaAviBody: 'Định dạng AVI không được trình phát tích hợp hỗ trợ, không thể phát trong ứng dụng. Tệp vẫn được nhúng nguyên vẹn và phát bình thường khi xuất ra PowerPoint.',
    legacyPptTitle: 'Không thể mở định dạng cũ .ppt',
    legacyPptBody: 'Đây là định dạng nhị phân PowerPoint 97-2003 (.ppt), ứng dụng chỉ hỗ trợ định dạng .pptx. Vui lòng mở trong PowerPoint/WPS/Keynote rồi chọn "Lưu thành .pptx", sau đó mở lại trong ứng dụng.',
    legacyPptOk: 'Đã hiểu',
    encryptedPptxTitle: 'Không thể mở tệp được bảo vệ bằng mật khẩu',
    encryptedPptxBody: 'Tệp này là tài liệu Office được mã hóa (bảo vệ bằng mật khẩu), ứng dụng hiện chưa hỗ trợ mở. Vui lòng mở trong PowerPoint, gỡ bỏ mật khẩu (Tệp → Thông tin → Bảo vệ bản trình chiếu), lưu lại rồi thử mở lại.',
    chartSimplifyTitle: 'Chỉnh sửa sẽ đơn giản hóa biểu đồ này',
    chartSimplifyBody: 'Biểu đồ này được tạo từ tệp bên ngoài. Sau khi chỉnh sửa, biểu đồ sẽ được dựng lại theo mô hình của ứng dụng; các định dạng chi tiết như định dạng số, đường xu hướng, thanh sai số và kiểu từng điểm sẽ bị mất.',
    chartSimplifyOk: 'Tiếp tục chỉnh sửa',
    untitledDraft: 'Bản trình chiếu chưa đặt tên',
    ...
    schemeThemeDefault: 'Mặc định theo chủ đề',
    ...
    errImageNoText: 'Tệp đính kèm hình ảnh không cung cấp văn bản, đã được gửi dưới dạng ảnh kèm theo tin nhắn của người dùng',
    errNotImage: 'Không phải định dạng hình ảnh được hỗ trợ',
    errGskNotLoggedIn: 'Chưa đăng nhập GenOffice: Vui lòng bấm vào "Đăng nhập Genspark" bên dưới để hoàn tất đăng nhập rồi thử lại',
    errNoApiKey: 'Chưa cấu hình Khóa API cho {provider}',
    errNoModel: 'Chưa cấu hình tên mô hình',
    errGskCli: 'gsk chưa đăng nhập: vui lòng chạy gsk login để đăng nhập tài khoản Genspark',
    errNoDeckAppend: 'Hiện không có bản trình chiếu nào để thêm trang (phiên làm việc không tồn tại). Vui lòng tạo trang đầu tiên trước hoặc dùng công cụ gốc để thêm trang.',
    errAppendFailed: 'Thêm trang thất bại: {reason}',
    errPartialAppend: 'Thêm một số trang thất bại: {reason}',
    errMergeFailed: 'Hợp nhất slide thất bại (file nguồn không có trang hợp lệ)',
    errNoDeckReplace: 'Hiện không có bản trình chiếu nào đang mở để làm lại trang.',
    errNoDeckInsert: 'Hiện không có bản trình chiếu nào đang mở để chèn trang.',
    errIndexRange: 'atIndex vượt ngoài phạm vi (0-{max})',
    errReplaceNeedsOne: 'Chế độ replace_at yêu cầu chính xác 1 trang HTML',
    errInsertNeedsOne: 'Chế độ insert_at yêu cầu chính xác 1 trang HTML',
    ...
    menuExportImages: 'Xuất thành hình ảnh…',
    menuPrint: 'In…',
    menuClose: 'Đóng',
    menuQuit: 'Thoát',
    menuEdit: 'Chỉnh sửa',
