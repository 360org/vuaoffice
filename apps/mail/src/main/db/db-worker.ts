  ...
  const demoEmails = [
    {
      ...
      threadId: 'thread_001',
      folderId: 'f_inbox',
      subject: 'Thông báo Kế hoạch Ra mắt VuaOffice 0.6.7 & VuaOffice Mail Module',
      senderName: 'VuaOffice Core Team',
      senderEmail: 'dev@360.org.vn',
      recipientSummary: 'Châu Lê, All Team',
      snippet: 'Kính gửi Sếp Châu, hệ sinh thái VuaOffice đã hoàn thiện bổ sung module VuaOffice Mail theo chuẩn Outlook UI...',
      bodyText: 'Kính gửi Sếp Châu,\n\nĐội ngũ phát triển VuaOffice xin báo cáo tiến độ cập nhật VuaOffice 0.6.7 với module VuaOffice Mail:\n- Tích hợp giao diện 3-Pane Outlook phong cách hiện đại.\n- Bộ đệm dữ liệu SQLite Local-First, hỗ trợ tìm kiếm siêu tốc độ.\n- Sẵn sàng tích hợp trợ lý AI thông minh.\n\nTrân trọng,\nVuaOffice Team',
      bodyHtml: '<p>Kính gửi <b>Sếp Châu</b>,</p><p>Đội ngũ phát triển VuaOffice xin báo cáo tiến độ cập nhật <b>VuaOffice 0.6.7</b> với module <b>VuaOffice Mail</b>:</p><ul><li>Tích hợp giao diện 3-Pane Outlook phong cách hiện đại.</li><li>Bộ đệm dữ liệu SQLite Local-First, hỗ trợ tìm kiếm siêu tốc độ.</li><li>Sẵn sàng tích hợp trợ lý AI thông minh.</li></ul><p>Trân trọng,<br><b>VuaOffice Team</b></p>',
      ...
      attachments: JSON.stringify([
        {
          id: 'att_01',
          name: 'VuaOffice-Architecture-Overview.pdf',
          size: '2.4 MB',
          ext: 'pdf',
          path: '/Volumes/DATA/DEV/VuaOffice Mail/docs/mail/ARCH.md',
        },
        {
          id: 'att_02',
          name: 'VuaOffice Mail-Specification.docx',
          size: '1.1 MB',
          ext: 'docx',
          path: '/Volumes/DATA/DEV/VuaOffice Mail/docs/mail/SPEC.md',
        },
      ]),
    },
    {
