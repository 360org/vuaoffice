...
const tMain = createI18n({
  ...
  vi: {
    ...
    dlgSaveAs: 'Lưu tài liệu Word',
    closeUnsavedMsg: 'Tài liệu này có những thay đổi chưa được lưu.',
    closeUnsavedDetail: 'Đóng mà không lưu sẽ làm mất các chỉnh sửa vừa thực hiện.',
    closeNoReplyMsg: 'Trợ lý AI đang phản hồi.',
    ...
    autosaveFoundBody: 'autosaveFoundBody',
    autosaveRestore: 'autosaveRestore',
    autosaveDiscard: 'autosaveDiscard',
    btnDontSave: 'btnDontSave',
    btnCancel: 'btnCancel',
    extModifiedMsg: 'extModifiedMsg',
    extModifiedDetail: 'extModifiedDetail',
    btnOverwrite: 'btnOverwrite',
    dlgInsertImage: 'dlgInsertImage',
    filterImages: 'filterImages',
    dlgAddAttachment: 'dlgAddAttachment',
    ...
    errImageNoText: 'errImageNoText',
    errNotImage: 'errNotImage',
    errGskNotLoggedIn: 'errGskNotLoggedIn',
    errNoApiKey: 'errNoApiKey',
    errNoModel: 'errNoModel',
    menuFile: 'Tệp',
    menuNewDoc: 'menuNewDoc',
    menuNewWindow: 'menuNewWindow',
    menuOpen: 'Mở…',
    ...
    menuFindReplace: 'menuFindReplace',
    menuSelectAll: 'Chọn tất cả',
    menuView: 'Xem',
    menuZoomIn: 'Phóng to',
    menuZoomOut: 'Thu nhỏ',
    menuZoom100: 'menuZoom100',
    menuPageWidth: 'menuPageWidth',
    menuWholePage: 'menuWholePage',
    menuAiSidebar: 'menuAiSidebar',
    menuDarkMode: 'menuDarkMode',
    menuFullscreen: 'menuFullscreen',
    menuInsert: 'Chèn',
    menuInsertTable: 'menuInsertTable',
    menuInsertImage: 'menuInsertImage',
    menuInsertPageBreak: 'menuInsertPageBreak',
    menuInsertLink: 'menuInsertLink',
    menuInsertEquation: 'menuInsertEquation',
    ...
    menuFont: 'menuFont',
    menuParagraph: 'menuParagraph',
    menuTools: 'menuTools',
    menuWordCount: 'menuWordCount',
    menuAiProofread: 'menuAiProofread',
    menuWindow: 'Cửa sổ',
    menuHelp: 'Trợ giúp',
