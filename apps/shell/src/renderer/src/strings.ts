...
export const strings = {
  zh: {
    ...
    onbStarHint: '如果你喜欢 GenOffice，欢迎到 Vua Office 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
  ...
  en: {
    ...
    onbStarHint: 'If you like GenOffice, give us a star on Vua Office.',
    setEmail: 'Email',
  ...
  ja: {
    ...
    starPromptLater: 'あとで',
    onbStarHint: 'GenOffice が気に入ったら、Vua Office でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    starPromptLater: '나중에',
    onbStarHint: 'GenOffice가 마음에 들면 Vua Office에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    onbStarHint: 'Si GenOffice vous plaît, mettez-nous une étoile sur Vua Office.',
    setEmail: 'E-mail',
  ...
  de: {
    ...
    onbStarHint: 'Wenn Ihnen GenOffice gefällt, geben Sie uns einen Stern auf Vua Office.',
    setEmail: 'E-Mail',
  ...
  es: {
    ...
    onbStarHint: 'Si te gusta GenOffice, danos una estrella en Vua Office.',
  ...
  th: {
    ...
    onbStarHint: 'ถ้าชอบ GenOffice ฝากกดดาวให้เราบน Vua Office ด้วยนะ',
    setEmail: 'อีเมล',
  ...
  id: {
    ...
    onbStarHint: 'Jika Anda menyukai GenOffice, beri kami bintang di Vua Office.',
    setEmail: 'Email',
  ...
  ru: {
    ...
    onbStarHint: 'Если вам нравится GenOffice, поставьте нам звезду на Vua Office.',
    setEmail: 'Эл. почта',
  ...
  ar: {
    ...
    onbStarHint: 'إذا أعجبك GenOffice، ضع لنا نجمة على Vua Office.',
  ...
  pt: {
    ...
    onbStarHint: 'Se você gosta do GenOffice, deixe uma estrela no Vua Office.',
    setEmail: 'E-mail',
  ...
  it: {
    ...
    onbStarHint: 'Se ti piace GenOffice, lasciaci una stella su Vua Office.',
    setEmail: 'Email',
  ...
  pl: {
    ...
    onbStarHint: 'Jeśli podoba Ci się GenOffice, zostaw nam gwiazdkę na Vua Office.',
    setEmail: 'E-mail',
  ...
  nl: {
    ...
    onbStarHint: 'Als GenOffice je bevalt, geef ons dan een ster op Vua Office.',
    setEmail: 'E-mail',
  ...
  ms: {
    ...
    onbStarHint: 'Jika anda suka GenOffice, beri kami bintang di Vua Office.',
    setEmail: 'E-mel',
  ...
  he: {
    ...
    onbStarHint: 'אם GenOffice מוצא חן בעיניכם, תנו לנו כוכב ב-Vua Office.',
    setEmail: 'אימייל',
  ...
  hi: {
    ...
    onbStarHint: 'अगर आपको GenOffice पसंद है, तो हमें Vua Office पर स्टार दें।',
    setEmail: 'ईमेल',
  ...
  'zh-TW': {
    ...
    onbStarHint: '如果你喜歡 GenOffice，歡迎到 Vua Office 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
  ...
  vi: {
    ...
    starPromptBody:
      'GenOffice là phần mềm nguồn mở và miễn phí. Tặng một ngôi sao trên GitHub là cách tuyệt vời nhất để ủng hộ đội ngũ phát triển.',
    starPromptGo: 'Tặng sao trên GitHub',
    starPromptDone: 'Đã tặng sao',
    starPromptLater: 'Để sau',
    onbStarHint: 'Nếu bạn yêu thích GenOffice, hãy tặng chúng tôi một ngôi sao trên Vua Office.',
    setEmail: 'Email',
    ...
    onbBody2:
      'GenOffice hiện đang trong giai đoạn phát triển. Hãy tham gia nhóm trò chuyện trên GenTeam để chia sẻ đóng góp và cùng nhau định hình tương lai.',
