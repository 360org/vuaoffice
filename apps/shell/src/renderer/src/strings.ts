...
export const strings = {
  zh: {
    ...
    setAiByokNote: '对话使用你自己的 key；网页搜索、生图等云工具仍需登录 VuaOffice。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
  ...
  ko: {
    ...
    setAiByokNote:
      '대화는 자신의 키를 사용합니다. 웹 검색·이미지 생성 등 클라우드 도구는 여전히 VuaOffice 로그인이 필요합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
  ...
  th: {
    ...
    setAiByokNote:
      'แชทใช้คีย์ของคุณเอง เครื่องมือคลาวด์ (ค้นเว็บ สร้างภาพ) ยังต้องลงชื่อเข้าใช้ VuaOffice',
    setAiSave: 'บันทึก',
  ...
  ar: {
    ...
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص؛ أدوات السحابة (بحث الويب وتوليد الصور) ما زالت تتطلب تسجيل الدخول إلى VuaOffice.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
  ...
  'zh-TW': {
    ...
    setAiByokNote: '對話使用你自己的 key；網頁搜尋、生圖等雲端工具仍需登入 VuaOffice。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
