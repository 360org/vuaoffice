...
export const strings = {
  zh: {
    ...
    defaultProject: "默认项目",
    deleteProject: "删除项目…",
    deleteProjectConfirm: "确认要删除此项目吗？",
    moveToProject: "移动到项目…",
    newProject: "新建项目",
    projEmpty: "此项目暂无文件",
    projEmptyHint: "在此项目中创建或移动文件。",
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: '360 CORP Projects',
    cloudSubtitle: '在网页端用 360 CORP AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 360 CORP 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountGenspark: '360 CORP 账号',
    account: '账号',
    login: '登录',
    loginGenspark: '登录 360 CORP 账号',
    loggedIn: '已登录',
    loggedInGenspark: '已登录 360 CORP',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 360 CORP,请检查网络或代理设置',
    ...
    intgHeroTitle: '在 AI 助手里使用 VuaOffice',
    intgHeroDesc:
    ...
    intgStep1Update: 'VuaOffice 升级带来新版 skill 时，对应助手旁会出现「更新」按钮。',
    ...
    intgOtherFolderDesc: '选择它的 skills 目录，VuaOffice 把文件写进去。',
    ...
    intgExample3: '把 budget.xlsx 转成 PDF，并在 VuaOffice 里打开',
    ...
    intgMcpPartDesc:
      'MCP 是 AI 助手调用外部工具的通用协议。助手不能运行命令（如 Claude Desktop），或你想让它直接操作 VuaOffice 窗口时用这条路。下面两种接法任选一种。',
    intgMcpStdioTitle: '由助手启动（推荐）',
    intgMcpStdioDesc:
      '助手自己拉起 genoffice mcp，不需要在这里开任何开关，VuaOffice 也不用开着。功能与 CLI 完全相同。',
    intgMcpHttpTitle: '本地 HTTP 服务',
    intgMcpHttpDesc:
      '在 VuaOffice 内运行，助手通过网址连接，可以看着它在 Word 编辑器里逐步生成。需要 VuaOffice 保持打开；目前只支持 Word。',
    intgMcpHttpAdvanced: '高级：其他地址与日志',
    intgMcpTryNote: '助手会通过 MCP 调用 VuaOffice，你不需要输入任何命令。',
    ...
    intgCopied: '已复制',
    intgCliEphemeral: '请先把 VuaOffice 拖到「应用程序」，再使用命令行。',
    intgCopyPath: '复制路径',
    intgCliNeedsUpdate: '此 skill 需要命令行 {v} 或更新版本，请更新 VuaOffice。',
    intgLoading: '正在检测…',
    ...
    onbStarButton: '打开 Vua Office',
    starPromptTitle: '喜欢 VuaOffice 吗？',
    starPromptTitleN: '你已经用 VuaOffice 打开了 {n} 个文档',
    starPromptBody: 'VuaOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 VuaOffice，欢迎到 Vua Office 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 VuaOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'VuaOffice 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ 360 CORP 积分**',
  ...
  en: {
    ...
    projEmpty: "No files in this project",
    projEmptyHint: "Create or move files into this project.",
    projMoreActions: "{name} more actions",
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Projects created on the web with 360 CORP AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your 360 CORP account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: '360 CORP Account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Sign in with 360 CORP',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Signed in to 360 CORP',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach 360 CORP — check your network or proxy settings',
    ...
    intgHeroTitle: 'Use VuaOffice from your AI assistant',
    intgHeroDesc:
    ...
    intgStep1Update:
      'When a VuaOffice update ships a newer skill, an Update button appears next to that assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pick its skills folder and VuaOffice writes the file there.',
    ...
    intgExample3: 'Convert budget.xlsx to PDF and open it in VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is the common protocol AI assistants use to call external tools. Use it when your assistant cannot run commands (Claude Desktop, for example) or when you want it to drive the VuaOffice window directly. Pick either of the two ways below.',
    intgMcpStdioTitle: 'Started by the assistant (recommended)',
    intgMcpStdioDesc:
      'The assistant launches genoffice mcp itself: nothing to switch on here, and VuaOffice does not need to be open. Same features as the CLI.',
    intgMcpHttpTitle: 'Local HTTP server',
    intgMcpHttpDesc:
      'Runs inside VuaOffice; the assistant connects to a URL and you can watch it build the document step by step in the Word editor. VuaOffice must stay open; Word documents only for now.',
    intgMcpHttpAdvanced: 'Advanced: other endpoints and log',
    intgMcpTryNote: 'The assistant calls VuaOffice through MCP; you never type a command.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copied',
    intgCliEphemeral: 'Drag VuaOffice into Applications first, then use the command line.',
    intgCopyPath: 'Copy path',
    intgCliNeedsUpdate: 'This skill needs command line {v} or newer; update VuaOffice.',
    ...
    onbStarButton: 'Open Vua Office',
    starPromptTitle: 'Enjoying VuaOffice?',
    starPromptTitleN: "You've opened {n} documents with VuaOffice",
    starPromptBody:
      'VuaOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like VuaOffice, give us a star on Vua Office.',
    setEmail: 'Email',
    ...
    onbCredits: 'Active contributors get **1,000+ 360 CORP credits**',
  ...
  ja: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Web で 360 CORP AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      '360 CORP アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: '360 CORP アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: '360 CORP アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInGenspark: '360 CORP にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      '360 CORP に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    intgHeroTitle: 'AI アシスタントから VuaOffice を使う',
    intgHeroDesc:
    ...
    intgStep1Update:
      'VuaOffice の更新で新しいスキルが届くと、そのアシスタントの横に「更新」ボタンが表示されます。',
    ...
    intgOtherFolderDesc: 'その skills フォルダーを選ぶと、VuaOffice がファイルを書き込みます。',
    ...
    intgExample3: 'budget.xlsx を PDF に変換して VuaOffice で開いて',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP は AI アシスタントが外部ツールを呼び出すための共通プロトコルです。アシスタントがコマンドを実行できない場合（Claude Desktop など）や、VuaOffice のウィンドウを直接操作させたい場合に使います。下の 2 つの方法からどちらか 1 つを選んでください。',
    intgMcpStdioTitle: 'アシスタントが起動する（推奨）',
    intgMcpStdioDesc:
      'アシスタントが genoffice mcp を自分で起動します。ここで何かをオンにする必要はなく、VuaOffice を開いておく必要もありません。機能は CLI と同じです。',
    intgMcpHttpTitle: 'ローカル HTTP サーバー',
    intgMcpHttpDesc:
      'VuaOffice 内で動作し、アシスタントは URL で接続します。Word エディター上で文書が段階的に生成される様子を見られます。VuaOffice を開いたままにする必要があり、現時点では Word のみ対応です。',
    intgMcpHttpAdvanced: '詳細：その他のエンドポイントとログ',
    intgMcpTryNote:
      'アシスタントが MCP 経由で VuaOffice を呼び出します。コマンドを入力する必要はありません。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'コピーしました',
    intgCliEphemeral:
      '先に VuaOffice を「アプリケーション」に移してから、コマンドラインを使ってください。',
    intgCopyPath: 'パスをコピー',
    intgCliNeedsUpdate:
      'このスキルにはコマンドライン {v} 以降が必要です。VuaOffice を更新してください。',
    intgLoading: '確認中…',
    ...
    onbStarButton: 'Vua Office を開く',
    starPromptTitle: 'VuaOffice はいかがですか？',
    starPromptTitleN: 'VuaOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'VuaOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'VuaOffice が気に入ったら、Vua Office でスターをお願いします。',
    setEmail: 'メール',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'VuaOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'VuaOffice はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ 360 CORP クレジット**',
  ...
  ko: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      '360 CORP AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: '360 CORP 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    intgHeroTitle: 'AI 어시스턴트에서 VuaOffice 사용하기',
    intgHeroDesc:
    ...
    intgStep1Update:
      'VuaOffice 업데이트에 새 스킬이 포함되면 해당 어시스턴트 옆에 업데이트 버튼이 나타납니다.',
    ...
    intgOtherFolderDesc: '해당 skills 폴더를 선택하면 VuaOffice가 파일을 기록합니다.',
    ...
    intgExample3: 'budget.xlsx를 PDF로 변환해서 VuaOffice에서 열어 줘',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP는 AI 어시스턴트가 외부 도구를 호출하는 공통 프로토콜입니다. 어시스턴트가 명령을 실행할 수 없거나(예: Claude Desktop) VuaOffice 창을 직접 조작하게 하려면 이 방식을 사용하세요. 아래 두 방법 중 하나를 선택하면 됩니다.',
    intgMcpStdioTitle: '어시스턴트가 실행(권장)',
    intgMcpStdioDesc:
      '어시스턴트가 genoffice mcp를 직접 실행합니다. 여기서 켤 것이 없고 VuaOffice가 열려 있을 필요도 없습니다. 기능은 CLI와 같습니다.',
    intgMcpHttpTitle: '로컬 HTTP 서버',
    intgMcpHttpDesc:
      'VuaOffice 안에서 실행되며 어시스턴트가 URL로 연결합니다. Word 편집기에서 문서가 단계별로 만들어지는 과정을 볼 수 있습니다. VuaOffice를 열어 두어야 하며 현재는 Word만 지원합니다.',
    intgMcpHttpAdvanced: '고급: 기타 주소와 로그',
    intgMcpTryNote:
      '어시스턴트가 MCP를 통해 VuaOffice를 호출합니다. 명령을 직접 입력할 필요가 없습니다.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: '복사됨',
    intgCliEphemeral: '먼저 VuaOffice를 응용 프로그램 폴더로 옮긴 뒤 명령줄을 사용하세요.',
    intgCopyPath: '경로 복사',
    intgCliNeedsUpdate: '이 스킬은 명령줄 {v} 이상이 필요합니다. VuaOffice를 업데이트하세요.',
    intgLoading: '확인 중…',
    ...
    setAiGensparkHint: 'VuaOffice 로그인으로 사용하며 API 키가 필요 없습니다.',
    ...
    setAiByokNote:
      '채팅은 내 키를 사용합니다. 이미지 생성과 미디어 분석은 「AI 미디어」 설정을 따르며, 웹 검색은 여전히 VuaOffice 로그인 또는 무료 소스를 사용합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    ...
    setAiMediaGensparkHint: '이미지 생성과 이미지/동영상 분석은 VuaOffice 로그인을 사용합니다.',
    setAiImageModel: '이미지 모델',
    setAiAnalysisModel: '분석 모델',
    setAiSearchGensparkHint:
      '웹 검색과 이미지 검색은 VuaOffice 로그인을 사용합니다. 로그아웃 상태거나 클라우드 도구가 꺼져 있으면 무료 소스로 대체됩니다.',
    ...
    onbStarButton: 'Vua Office 열기',
    starPromptTitle: 'VuaOffice가 마음에 드시나요?',
    starPromptTitleN: 'VuaOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'VuaOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'VuaOffice가 마음에 들면 Vua Office에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      "Projets créés sur le web avec 360 CORP AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte 360 CORP pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte 360 CORP',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Se connecter avec 360 CORP',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté à 360 CORP',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre 360 CORP — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    intgHeroTitle: 'Utiliser VuaOffice depuis votre assistant IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quand une mise à jour de VuaOffice apporte un skill plus récent, un bouton Mettre à jour apparaît à côté de cet assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Choisissez son dossier skills et VuaOffice y écrit le fichier.',
    ...
    intgExample3: 'Convertis budget.xlsx en PDF et ouvre-le dans VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP est le protocole commun que les assistants IA utilisent pour appeler des outils externes. Utilisez-le si votre assistant ne peut pas lancer de commandes (Claude Desktop, par exemple) ou si vous voulez qu’il pilote directement la fenêtre VuaOffice. Choisissez l’une des deux méthodes ci-dessous.',
    intgMcpStdioTitle: 'Lancé par l’assistant (recommandé)',
    intgMcpStdioDesc:
      'L’assistant lance lui-même genoffice mcp : rien à activer ici, et VuaOffice n’a pas besoin d’être ouvert. Mêmes fonctions que la CLI.',
    intgMcpHttpTitle: 'Serveur HTTP local',
    intgMcpHttpDesc:
      'Tourne dans VuaOffice ; l’assistant se connecte à une URL et vous voyez le document se construire pas à pas dans l’éditeur Word. VuaOffice doit rester ouvert ; documents Word uniquement pour l’instant.',
    intgMcpHttpAdvanced: 'Avancé : autres adresses et journal',
    intgMcpTryNote: 'L’assistant appelle VuaOffice via MCP ; vous ne tapez jamais de commande.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copié',
    intgCliEphemeral:
      "Glissez d'abord VuaOffice dans Applications, puis utilisez la ligne de commande.",
    intgCopyPath: 'Copier le chemin',
    intgCliNeedsUpdate:
      'Ce skill requiert la ligne de commande {v} ou plus récente ; mettez VuaOffice à jour.',
    ...
    onbStarButton: 'Ouvrir Vua Office',
    starPromptTitle: 'VuaOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec VuaOffice',
    starPromptBody:
      'VuaOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si VuaOffice vous plaît, mettez-nous une étoile sur Vua Office.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans VuaOffice',
    ...
    onbBody2:
      'VuaOffice est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits 360 CORP**',
  ...
  de: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Mit 360 CORP AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem 360 CORP-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountGenspark: '360 CORP-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginGenspark: 'Mit 360 CORP anmelden',
    loggedIn: 'Angemeldet',
    loggedInGenspark: 'Bei 360 CORP angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      '360 CORP ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    intgHeroTitle: 'VuaOffice aus Ihrem KI-Assistenten nutzen',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Bringt ein VuaOffice-Update einen neueren Skill mit, erscheint neben diesem Assistenten ein Aktualisieren-Button.',
    intgSkillVersion: 'Skill {v}',
    ...
    intgOtherFolderDesc:
      'Wählen Sie seinen Skills-Ordner, und VuaOffice schreibt die Datei dorthin.',
    ...
    intgExample3: 'Wandle budget.xlsx in PDF um und öffne es in VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ist das gemeinsame Protokoll, über das KI-Assistenten externe Werkzeuge aufrufen. Nutzen Sie es, wenn der Assistent keine Befehle ausführen kann (z. B. Claude Desktop) oder wenn er das VuaOffice-Fenster direkt steuern soll. Wählen Sie einen der beiden Wege unten.',
    intgMcpStdioTitle: 'Vom Assistenten gestartet (empfohlen)',
    intgMcpStdioDesc:
      'Der Assistent startet genoffice mcp selbst: hier ist nichts einzuschalten, und VuaOffice muss nicht geöffnet sein. Gleicher Funktionsumfang wie die CLI.',
    intgMcpHttpTitle: 'Lokaler HTTP-Server',
    intgMcpHttpDesc:
      'Läuft in VuaOffice; der Assistent verbindet sich über eine URL, und Sie sehen im Word-Editor zu, wie das Dokument Schritt für Schritt entsteht. VuaOffice muss geöffnet bleiben; derzeit nur Word-Dokumente.',
    intgMcpHttpAdvanced: 'Erweitert: weitere Adressen und Protokoll',
    intgMcpTryNote: 'Der Assistent ruft VuaOffice über MCP auf; Sie tippen nie einen Befehl.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Kopiert',
    intgCliEphemeral:
      'Ziehen Sie VuaOffice zuerst in „Programme“, dann nutzen Sie die Befehlszeile.',
    intgCopyPath: 'Pfad kopieren',
    intgCliNeedsUpdate:
      'Dieser Skill braucht Befehlszeile {v} oder neuer; aktualisieren Sie VuaOffice.',
    intgLoading: 'Prüfe …',
    ...
    onbStarButton: 'Vua Office öffnen',
    starPromptTitle: 'Gefällt Ihnen VuaOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit VuaOffice geöffnet',
    starPromptBody:
      'VuaOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen VuaOffice gefällt, geben Sie uns einen Stern auf Vua Office.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei VuaOffice',
    ...
    onbBody2:
      'VuaOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ 360 CORP-Guthaben**',
  ...
  es: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Proyectos creados en la web con 360 CORP AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de 360 CORP para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountGenspark: 'Cuenta de 360 CORP',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginGenspark: 'Iniciar sesión con 360 CORP',
    loggedIn: 'Sesión iniciada',
    loggedInGenspark: 'Sesión iniciada en 360 CORP',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con 360 CORP — compruebe su red o la configuración del proxy',
    ...
    intgHeroTitle: 'Usa VuaOffice desde tu asistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Cuando una actualización de VuaOffice traiga un skill más nuevo, aparecerá un botón Actualizar junto a ese asistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Elige su carpeta de skills y VuaOffice escribe el archivo ahí.',
    ...
    intgExample3: 'Convierte budget.xlsx a PDF y ábrelo en VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP es el protocolo común con el que los asistentes de IA llaman a herramientas externas. Úsalo cuando tu asistente no pueda ejecutar comandos (Claude Desktop, por ejemplo) o cuando quieras que controle directamente la ventana de VuaOffice. Elige una de las dos formas de abajo.',
    intgMcpStdioTitle: 'Iniciado por el asistente (recomendado)',
    intgMcpStdioDesc:
      'El asistente lanza genoffice mcp por sí mismo: nada que activar aquí, y VuaOffice no necesita estar abierto. Mismas funciones que la CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Se ejecuta dentro de VuaOffice; el asistente se conecta a una URL y puedes ver cómo construye el documento paso a paso en el editor de Word. VuaOffice debe permanecer abierto; por ahora solo documentos Word.',
    intgMcpHttpAdvanced: 'Avanzado: otras direcciones y registro',
    intgMcpTryNote: 'El asistente llama a VuaOffice a través de MCP; nunca escribes un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral: 'Arrastra primero VuaOffice a Aplicaciones y luego usa la línea de comandos.',
    intgCopyPath: 'Copiar ruta',
    intgCliNeedsUpdate:
      'Este skill necesita la línea de comandos {v} o superior; actualiza VuaOffice.',
    ...
    onbStarButton: 'Abrir Vua Office',
    starPromptTitle: '¿Te gusta VuaOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con VuaOffice',
    starPromptBody:
      'VuaOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta VuaOffice, danos una estrella en Vua Office.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a VuaOffice',
    ...
    onbBody2:
      'VuaOffice aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de 360 CORP**',
  ...
  th: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย 360 CORP AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี 360 CORP เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountGenspark: 'บัญชี 360 CORP',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginGenspark: 'ลงชื่อเข้าใช้ด้วย 360 CORP',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInGenspark: 'ลงชื่อเข้าใช้ 360 CORP แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ 360 CORP ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    intgHeroTitle: 'ใช้ VuaOffice จากผู้ช่วย AI ของคุณ',
    intgHeroDesc:
    ...
    intgStep1Update:
      'เมื่อการอัปเดต VuaOffice มาพร้อมสกิลเวอร์ชันใหม่ ปุ่มอัปเดตจะปรากฏข้างผู้ช่วยนั้น',
    ...
    intgOtherFolderDesc: 'เลือกโฟลเดอร์ skills ของผู้ช่วย แล้ว VuaOffice จะเขียนไฟล์ลงไป',
    ...
    intgExample3: 'แปลง budget.xlsx เป็น PDF แล้วเปิดใน VuaOffice',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP คือโปรโตคอลกลางที่ผู้ช่วย AI ใช้เรียกเครื่องมือภายนอก ใช้เมื่อผู้ช่วยรันคำสั่งไม่ได้ (เช่น Claude Desktop) หรือเมื่อต้องการให้มันควบคุมหน้าต่าง VuaOffice โดยตรง เลือกวิธีใดวิธีหนึ่งจากสองวิธีด้านล่าง',
    intgMcpStdioTitle: 'ให้ผู้ช่วยเป็นผู้เริ่ม (แนะนำ)',
    intgMcpStdioDesc:
      'ผู้ช่วยจะเรียก genoffice mcp ขึ้นมาเอง ไม่ต้องเปิดสวิตช์ใดที่นี่ และไม่ต้องเปิด VuaOffice ไว้ ความสามารถเหมือน CLI ทุกประการ',
    intgMcpHttpTitle: 'เซิร์ฟเวอร์ HTTP ในเครื่อง',
    intgMcpHttpDesc:
      'ทำงานอยู่ใน VuaOffice ผู้ช่วยเชื่อมต่อผ่าน URL และคุณจะเห็นเอกสารค่อย ๆ ถูกสร้างขึ้นในตัวแก้ไข Word ต้องเปิด VuaOffice ไว้ตลอด ปัจจุบันรองรับเฉพาะ Word',
    intgMcpHttpAdvanced: 'ขั้นสูง: ที่อยู่อื่นและบันทึก',
    intgMcpTryNote: 'ผู้ช่วยจะเรียก VuaOffice ผ่าน MCP คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'กรุณาลาก VuaOffice ไปที่ Applications ก่อน แล้วจึงใช้บรรทัดคำสั่ง',
    intgCopyPath: 'คัดลอกพาธ',
    intgCliNeedsUpdate: 'สกิลนี้ต้องใช้บรรทัดคำสั่ง {v} หรือใหม่กว่า โปรดอัปเดต VuaOffice',
    ...
    setAiGensparkHint: 'ใช้การลงชื่อเข้าใช้ VuaOffice ไม่ต้องใช้คีย์ API',
    ...
    setAiByokNote:
      'การแชทใช้คีย์ของคุณเอง การสร้างภาพและการวิเคราะห์สื่อเป็นไปตามส่วน "สื่อ AI" ส่วนการค้นหาเว็บยังใช้การลงชื่อเข้าใช้ VuaOffice หรือแหล่งข้อมูลฟรี',
    setAiSave: 'บันทึก',
    ...
    setAiMediaGensparkHint:
      'การสร้างภาพและการวิเคราะห์ภาพ/วิดีโอใช้การลงชื่อเข้าใช้ VuaOffice ของคุณ',
    setAiImageModel: 'โมเดลสร้างภาพ',
    setAiAnalysisModel: 'โมเดลวิเคราะห์',
    setAiSearchGensparkHint:
      'การค้นหาเว็บและภาพใช้การลงชื่อเข้าใช้ VuaOffice หากไม่ได้ลงชื่อเข้าใช้หรือปิดเครื่องมือคลาวด์ จะใช้แหล่งข้อมูลฟรีแทน',
    ...
    onbStarButton: 'เปิด Vua Office',
    starPromptTitle: 'ชอบ VuaOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย VuaOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'VuaOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ VuaOffice ฝากกดดาวให้เราบน Vua Office ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ VuaOffice',
    ...
    onbBody2:
      'VuaOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต 360 CORP กว่า 1,000**',
  ...
  id: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan 360 CORP AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun 360 CORP untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountGenspark: 'Akun 360 CORP',
    account: 'Akun',
    login: 'Masuk',
    loginGenspark: 'Masuk dengan 360 CORP',
    loggedIn: 'Sudah masuk',
    loggedInGenspark: 'Sudah masuk ke 360 CORP',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke 360 CORP — periksa jaringan atau pengaturan proxy Anda',
    ...
    intgHeroTitle: 'Gunakan VuaOffice dari asisten AI Anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Saat pembaruan VuaOffice membawa skill yang lebih baru, tombol Perbarui muncul di samping asisten itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills-nya dan VuaOffice menulis file di sana.',
    ...
    intgExample3: 'Konversi budget.xlsx ke PDF dan buka di VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP adalah protokol umum yang dipakai asisten AI untuk memanggil alat eksternal. Gunakan saat asisten Anda tidak bisa menjalankan perintah (misalnya Claude Desktop) atau saat Anda ingin ia mengendalikan jendela VuaOffice secara langsung. Pilih salah satu dari dua cara di bawah.',
    intgMcpStdioTitle: 'Dijalankan oleh asisten (disarankan)',
    intgMcpStdioDesc:
      'Asisten menjalankan genoffice mcp sendiri: tidak ada yang perlu dinyalakan di sini, dan VuaOffice tidak perlu terbuka. Fitur sama dengan CLI.',
    intgMcpHttpTitle: 'Server HTTP lokal',
    intgMcpHttpDesc:
      'Berjalan di dalam VuaOffice; asisten terhubung lewat URL dan Anda bisa melihat dokumen dibangun langkah demi langkah di editor Word. VuaOffice harus tetap terbuka; untuk saat ini hanya dokumen Word.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote: 'Asisten memanggil VuaOffice melalui MCP; Anda tidak pernah mengetik perintah.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret VuaOffice ke Applications dulu, lalu gunakan baris perintah.',
    intgCopyPath: 'Salin path',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris perintah {v} atau lebih baru; perbarui VuaOffice.',
    ...
    onbStarButton: 'Buka Vua Office',
    starPromptTitle: 'Suka VuaOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan VuaOffice',
    starPromptBody:
      'VuaOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai VuaOffice, beri kami bintang di Vua Office.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di VuaOffice',
    ...
    onbBody2:
      'VuaOffice masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit 360 CORP**',
  ...
  ru: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с 360 CORP AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт 360 CORP, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountGenspark: 'Учётная запись 360 CORP',
    account: 'Учётная запись',
    login: 'Войти',
    loginGenspark: 'Войти через 360 CORP',
    loggedIn: 'Вход выполнен',
    loggedInGenspark: 'Выполнен вход в 360 CORP',
    ...
    loginNetworkError: 'Не удаётся подключиться к 360 CORP — проверьте сеть или настройки прокси',
    ...
    intgHeroTitle: 'Используйте VuaOffice из своего ИИ-ассистента',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Когда обновление VuaOffice принесёт более новый скилл, рядом с этим ассистентом появится кнопка «Обновить».',
    ...
    intgOtherFolderDesc: 'Выберите его папку skills, и VuaOffice запишет файл туда.',
    ...
    intgExample3: 'Конвертируй budget.xlsx в PDF и открой в VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP — общий протокол, через который ИИ-ассистенты вызывают внешние инструменты. Используйте его, если ассистент не умеет выполнять команды (например, Claude Desktop) или если хотите, чтобы он напрямую управлял окном VuaOffice. Выберите один из двух способов ниже.',
    intgMcpStdioTitle: 'Запускает ассистент (рекомендуется)',
    intgMcpStdioDesc:
      'Ассистент сам запускает genoffice mcp: здесь ничего включать не нужно, и VuaOffice не обязан быть открыт. Те же возможности, что у CLI.',
    intgMcpHttpTitle: 'Локальный HTTP-сервер',
    intgMcpHttpDesc:
      'Работает внутри VuaOffice; ассистент подключается по URL, и вы видите, как документ шаг за шагом собирается в редакторе Word. VuaOffice должен оставаться открытым; пока только документы Word.',
    intgMcpHttpAdvanced: 'Дополнительно: другие адреса и журнал',
    intgMcpTryNote: 'Ассистент обращается к VuaOffice через MCP; вам не нужно вводить команды.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral:
      'Сначала перетащите VuaOffice в «Программы», затем используйте командную строку.',
    intgCopyPath: 'Копировать путь',
    intgCliNeedsUpdate: 'Этому скиллу нужна командная строка {v} или новее; обновите VuaOffice.',
    ...
    onbStarButton: 'Открыть Vua Office',
    starPromptTitle: 'Нравится VuaOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в VuaOffice',
    starPromptBody:
      'VuaOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится VuaOffice, поставьте нам звезду на Vua Office.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в VuaOffice',
    ...
    onbBody2:
      'VuaOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов 360 CORP**',
  ...
  ar: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام 360 CORP AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب 360 CORP لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountGenspark: 'حساب 360 CORP',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginGenspark: 'تسجيل الدخول باستخدام 360 CORP',
    loggedIn: 'تم تسجيل الدخول',
    loggedInGenspark: 'تم تسجيل الدخول إلى 360 CORP',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ 360 CORP — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    intgHeroTitle: 'استخدم VuaOffice من مساعد الذكاء الاصطناعي',
    intgHeroDesc:
    ...
    intgStep1Update: 'عندما يجلب تحديث VuaOffice مهارة أحدث، يظهر زر «تحديث» بجوار ذلك المساعد.',
    ...
    intgOtherFolderDesc: 'اختر مجلد skills الخاص به وسيكتب VuaOffice الملف هناك.',
    ...
    intgExample3: 'حوّل budget.xlsx إلى PDF وافتحه في VuaOffice',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP هو البروتوكول المشترك الذي يستخدمه مساعدو الذكاء الاصطناعي لاستدعاء أدوات خارجية. استخدمه إذا كان مساعدك لا يستطيع تنفيذ الأوامر (مثل Claude Desktop) أو إذا أردت أن يتحكم في نافذة VuaOffice مباشرة. اختر إحدى الطريقتين أدناه.',
    intgMcpStdioTitle: 'يشغّله المساعد (موصى به)',
    intgMcpStdioDesc:
      'يشغّل المساعد genoffice mcp بنفسه: لا شيء لتفعيله هنا، ولا يلزم أن يكون VuaOffice مفتوحًا. نفس إمكانات CLI.',
    intgMcpHttpTitle: 'خادم HTTP محلي',
    intgMcpHttpDesc:
      'يعمل داخل VuaOffice؛ يتصل المساعد عبر عنوان URL ويمكنك مشاهدة المستند يُبنى خطوة بخطوة في محرر Word. يجب أن يبقى VuaOffice مفتوحًا؛ مستندات Word فقط حاليًا.',
    intgMcpHttpAdvanced: 'متقدم: عناوين أخرى والسجل',
    intgMcpTryNote: 'يستدعي المساعد VuaOffice عبر MCP؛ لن تكتب أي أمر.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'تم النسخ',
    intgCliEphemeral: 'اسحب VuaOffice إلى مجلد التطبيقات أولاً، ثم استخدم سطر الأوامر.',
    intgCopyPath: 'نسخ المسار',
    intgCliNeedsUpdate: 'تحتاج هذه المهارة إلى سطر الأوامر {v} أو أحدث؛ حدّث VuaOffice.',
    ...
    setAiGensparkHint: 'يستخدم تسجيل الدخول إلى VuaOffice؛ لا حاجة لمفتاح API.',
    ...
    onbStarButton: 'فتح Vua Office',
    starPromptTitle: 'هل أعجبك VuaOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في VuaOffice',
    starPromptBody: 'VuaOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك VuaOffice، ضع لنا نجمة على Vua Office.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في VuaOffice',
    ...
    onbBody2:
      'لا يزال VuaOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة 360 CORP**',
  ...
  pt: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Projetos criados na web com o 360 CORP AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta 360 CORP para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountGenspark: 'Conta 360 CORP',
    account: 'Conta',
    login: 'Entrar',
    loginGenspark: 'Entrar com a 360 CORP',
    loggedIn: 'Conectado',
    loggedInGenspark: 'Conectado à 360 CORP',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao 360 CORP — verifique sua rede ou as configurações de proxy',
    ...
    intgHeroTitle: 'Use o VuaOffice a partir do seu assistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quando uma atualização do VuaOffice trouxer um skill mais novo, um botão Atualizar aparece ao lado desse assistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Escolha a pasta de skills dele e o VuaOffice grava o arquivo lá.',
    ...
    intgExample3: 'Converta budget.xlsx para PDF e abra no VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP é o protocolo comum que assistentes de IA usam para chamar ferramentas externas. Use-o quando o assistente não puder executar comandos (Claude Desktop, por exemplo) ou quando quiser que ele controle a janela do VuaOffice diretamente. Escolha uma das duas formas abaixo.',
    intgMcpStdioTitle: 'Iniciado pelo assistente (recomendado)',
    intgMcpStdioDesc:
      'O assistente inicia o genoffice mcp sozinho: nada para ligar aqui, e o VuaOffice não precisa estar aberto. Mesmos recursos da CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Roda dentro do VuaOffice; o assistente conecta por URL e você acompanha o documento sendo montado passo a passo no editor Word. O VuaOffice precisa ficar aberto; por enquanto só documentos Word.',
    intgMcpHttpAdvanced: 'Avançado: outros endereços e log',
    intgMcpTryNote: 'O assistente chama o VuaOffice via MCP; você nunca digita um comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral:
      'Arraste o VuaOffice para Aplicativos primeiro e depois use a linha de comando.',
    intgCopyPath: 'Copiar caminho',
    intgCliNeedsUpdate:
      'Este skill precisa da linha de comando {v} ou mais recente; atualize o VuaOffice.',
    ...
    onbStarButton: 'Abrir Vua Office',
    starPromptTitle: 'Gostando do VuaOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o VuaOffice',
    starPromptBody:
      'O VuaOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do VuaOffice, deixe uma estrela no Vua Office.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao VuaOffice',
    ...
    onbBody2:
      'O VuaOffice ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos 360 CORP**',
  ...
  it: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Progetti creati sul web con 360 CORP AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account 360 CORP per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountGenspark: 'Account 360 CORP',
    account: 'Account',
    login: 'Accedi',
    loginGenspark: 'Accedi con 360 CORP',
    loggedIn: 'Accesso effettuato',
    loggedInGenspark: 'Accesso effettuato a 360 CORP',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere 360 CORP — controlla la rete o le impostazioni del proxy',
    ...
    intgHeroTitle: 'Usa VuaOffice dal tuo assistente IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      "Quando un aggiornamento di VuaOffice porta uno skill più recente, accanto a quell'assistente compare un pulsante Aggiorna.",
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Scegli la sua cartella skills e VuaOffice vi scrive il file.',
    ...
    intgExample3: 'Converti budget.xlsx in PDF e aprilo in VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP è il protocollo comune con cui gli assistenti IA richiamano strumenti esterni. Usalo quando l’assistente non può eseguire comandi (Claude Desktop, ad esempio) o quando vuoi che controlli direttamente la finestra di VuaOffice. Scegli uno dei due modi qui sotto.',
    intgMcpStdioTitle: 'Avviato dall’assistente (consigliato)',
    intgMcpStdioDesc:
      'L’assistente avvia genoffice mcp da sé: niente da attivare qui, e VuaOffice non deve essere aperto. Stesse funzioni della CLI.',
    intgMcpHttpTitle: 'Server HTTP locale',
    intgMcpHttpDesc:
      'Gira dentro VuaOffice; l’assistente si collega a un URL e puoi vedere il documento prendere forma passo dopo passo nell’editor Word. VuaOffice deve restare aperto; per ora solo documenti Word.',
    intgMcpHttpAdvanced: 'Avanzato: altri indirizzi e registro',
    intgMcpTryNote: 'L’assistente richiama VuaOffice tramite MCP; non digiti mai un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copiato',
    intgCliEphemeral: 'Trascina prima VuaOffice in Applicazioni, poi usa la riga di comando.',
    intgCopyPath: 'Copia percorso',
    intgCliNeedsUpdate:
      'Questo skill richiede la riga di comando {v} o successiva; aggiorna VuaOffice.',
    ...
    onbStarButton: 'Apri Vua Office',
    starPromptTitle: 'Ti piace VuaOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con VuaOffice',
    starPromptBody:
      'VuaOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace VuaOffice, lasciaci una stella su Vua Office.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in VuaOffice',
    ...
    onbBody2:
      'VuaOffice è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti 360 CORP**',
  ...
  pl: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą 360 CORP AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto 360 CORP, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountGenspark: 'Konto 360 CORP',
    account: 'Konto',
    login: 'Zaloguj się',
    loginGenspark: 'Zaloguj się przez 360 CORP',
    loggedIn: 'Zalogowano',
    loggedInGenspark: 'Zalogowano do 360 CORP',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z 360 CORP — sprawdź sieć lub ustawienia proxy',
    ...
    intgHeroTitle: 'Używaj VuaOffice ze swojego asystenta AI',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Gdy aktualizacja VuaOffice przyniesie nowszy skill, obok tego asystenta pojawi się przycisk Aktualizuj.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Wybierz jego folder skills, a VuaOffice zapisze tam plik.',
    ...
    intgExample3: 'Przekonwertuj budget.xlsx do PDF i otwórz w VuaOffice',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP to wspólny protokół, którym asystenci AI wywołują zewnętrzne narzędzia. Użyj go, gdy asystent nie potrafi uruchamiać poleceń (np. Claude Desktop) lub gdy chcesz, aby bezpośrednio sterował oknem VuaOffice. Wybierz jeden z dwóch sposobów poniżej.',
    intgMcpStdioTitle: 'Uruchamiany przez asystenta (zalecane)',
    intgMcpStdioDesc:
      'Asystent sam uruchamia genoffice mcp: nic tu nie trzeba włączać, a VuaOffice nie musi być otwarty. Te same funkcje co CLI.',
    intgMcpHttpTitle: 'Lokalny serwer HTTP',
    intgMcpHttpDesc:
      'Działa wewnątrz VuaOffice; asystent łączy się przez URL, a Ty widzisz, jak dokument powstaje krok po kroku w edytorze Word. VuaOffice musi pozostać otwarty; na razie tylko dokumenty Word.',
    intgMcpHttpAdvanced: 'Zaawansowane: inne adresy i dziennik',
    intgMcpTryNote: 'Asystent wywołuje VuaOffice przez MCP; nigdy nie wpisujesz polecenia.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'Najpierw przenieś VuaOffice do Aplikacji, potem użyj wiersza poleceń.',
    intgCopyPath: 'Kopiuj ścieżkę',
    intgCliNeedsUpdate: 'Ten skill wymaga wiersza poleceń {v} lub nowszego; zaktualizuj VuaOffice.',
    ...
    onbStarButton: 'Otwórz Vua Office',
    starPromptTitle: 'Podoba Ci się VuaOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w VuaOffice',
    starPromptBody:
      'VuaOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się VuaOffice, zostaw nam gwiazdkę na Vua Office.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'VuaOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów 360 CORP**',
  ...
  cs: {
    ...
    cloudSubtitle:
      'Projekty vytvořené na webu pomocí VuaOffice AI. Úpravy pokračují v prohlížeči — klikněte na projekt a otevřete ho.',
    ...
    intgHeroTitle: 'Používejte VuaOffice ze svého AI asistenta',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Když aktualizace VuaOffice přinese novější skill, u daného asistenta se objeví tlačítko Aktualizovat.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Vyberte jeho složku skills a VuaOffice tam soubor zapíše.',
    ...
    intgExample3: 'Převeď budget.xlsx do PDF a otevři ho v VuaOffice',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP je společný protokol, kterým AI asistenti volají externí nástroje. Použijte ho, když asistent neumí spouštět příkazy (např. Claude Desktop) nebo když chcete, aby přímo ovládal okno VuaOffice. Vyberte jeden ze dvou způsobů níže.',
    intgMcpStdioTitle: 'Spouští asistent (doporučeno)',
    intgMcpStdioDesc:
      'Asistent spustí genoffice mcp sám: tady není co zapínat a VuaOffice nemusí být otevřený. Stejné funkce jako CLI.',
    intgMcpHttpTitle: 'Místní HTTP server',
    intgMcpHttpDesc:
      'Běží uvnitř VuaOffice; asistent se připojí přes URL a v editoru Word sledujete, jak dokument krok za krokem vzniká. VuaOffice musí zůstat otevřený; zatím jen dokumenty Word.',
    intgMcpHttpAdvanced: 'Pokročilé: další adresy a protokol',
    intgMcpTryNote: 'Asistent volá VuaOffice přes MCP; žádný příkaz nepíšete.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'Nejprve přetáhněte VuaOffice do Aplikací a poté použijte příkazový řádek.',
    intgCopyPath: 'Kopírovat cestu',
    intgCliNeedsUpdate:
      'Tento skill vyžaduje příkazový řádek {v} nebo novější; aktualizujte VuaOffice.',
    ...
    starPromptTitle: 'Líbí se vám VuaOffice?',
    starPromptTitleN: 'V VuaOffice jste otevřeli už {n} dokumentů',
    starPromptBody:
      'VuaOffice je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám VuaOffice líbí, dejte nám hvězdičku na GitHubu.',
    onbStarButton: 'Otevřít Vua Office',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'VuaOffice je stále ve fázi alfa. Připojte se ke skupinovému chatu na GenTeam, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',
  ...
  nl: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met 360 CORP AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je 360 CORP-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginGenspark: 'Inloggen met 360 CORP',
    loggedIn: 'Ingelogd',
    loggedInGenspark: 'Ingelogd bij 360 CORP',
    ...
    loginNetworkError: 'Kan 360 CORP niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    intgHeroTitle: 'VuaOffice gebruiken vanuit uw AI-assistent',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Wanneer een VuaOffice-update een nieuwere skill meebrengt, verschijnt naast die assistent een knop Bijwerken.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Kies zijn skills-map en VuaOffice schrijft het bestand daar.',
    ...
    intgExample3: 'Zet budget.xlsx om naar PDF en open het in VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is het gemeenschappelijke protocol waarmee AI-assistenten externe tools aanroepen. Gebruik het als je assistent geen opdrachten kan uitvoeren (bijvoorbeeld Claude Desktop) of als je wilt dat hij het VuaOffice-venster rechtstreeks bestuurt. Kies een van de twee manieren hieronder.',
    intgMcpStdioTitle: 'Gestart door de assistent (aanbevolen)',
    intgMcpStdioDesc:
      'De assistent start genoffice mcp zelf: hier hoeft niets aan, en VuaOffice hoeft niet open te staan. Dezelfde functies als de CLI.',
    intgMcpHttpTitle: 'Lokale HTTP-server',
    intgMcpHttpDesc:
      'Draait in VuaOffice; de assistent verbindt via een URL en je ziet het document stap voor stap ontstaan in de Word-editor. VuaOffice moet open blijven; voorlopig alleen Word-documenten.',
    intgMcpHttpAdvanced: 'Geavanceerd: andere adressen en logboek',
    intgMcpTryNote: 'De assistent roept VuaOffice aan via MCP; je typt nooit een opdracht.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: "Sleep VuaOffice eerst naar Programma's en gebruik daarna de opdrachtregel.",
    intgCopyPath: 'Pad kopiëren',
    intgCliNeedsUpdate: 'Deze skill vereist opdrachtregel {v} of nieuwer; werk VuaOffice bij.',
    ...
    onbStarButton: 'Open Vua Office',
    starPromptTitle: 'Bevalt VuaOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met VuaOffice',
    starPromptBody:
      'VuaOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als VuaOffice je bevalt, geef ons dan een ster op Vua Office.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij VuaOffice',
    ...
    onbBody2:
      'VuaOffice is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ 360 CORP-credits**',
  ...
  ms: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan 360 CORP AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun 360 CORP untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountGenspark: 'Akaun 360 CORP',
    account: 'Akaun',
    login: 'Log masuk',
    loginGenspark: 'Log masuk dengan 360 CORP',
    loggedIn: 'Telah log masuk',
    loggedInGenspark: 'Telah log masuk ke 360 CORP',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke 360 CORP — semak rangkaian atau tetapan proksi anda',
    ...
    setSecAbout: 'Perihal',
    setSecIntegrations: 'Integrasi',
    intgHeroTitle: 'Gunakan VuaOffice daripada pembantu AI anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Apabila kemas kini VuaOffice membawa skill yang lebih baharu, butang Kemas kini muncul di sebelah pembantu itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills pembantu itu dan VuaOffice menulis fail di sana.',
    ...
    intgExample3: 'Tukar budget.xlsx kepada PDF dan buka dalam VuaOffice',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ialah protokol umum yang digunakan pembantu AI untuk memanggil alat luaran. Gunakannya apabila pembantu anda tidak boleh menjalankan arahan (contohnya Claude Desktop) atau apabila anda mahu ia mengawal tetingkap VuaOffice secara langsung. Pilih salah satu daripada dua cara di bawah.',
    intgMcpStdioTitle: 'Dimulakan oleh pembantu (disyorkan)',
    intgMcpStdioDesc:
      'Pembantu melancarkan genoffice mcp sendiri: tiada apa yang perlu dihidupkan di sini, dan VuaOffice tidak perlu dibuka. Ciri sama seperti CLI.',
    intgMcpHttpTitle: 'Pelayan HTTP tempatan',
    intgMcpHttpDesc:
      'Berjalan di dalam VuaOffice; pembantu menyambung melalui URL dan anda boleh melihat dokumen dibina langkah demi langkah dalam editor Word. VuaOffice mesti kekal dibuka; buat masa ini dokumen Word sahaja.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote:
      'Pembantu memanggil VuaOffice melalui MCP; anda tidak perlu menaip sebarang arahan.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgSavedTo: 'Disimpan ke {path}',
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret VuaOffice ke Applications dahulu, kemudian gunakan baris arahan.',
    intgCopyPath: 'Salin laluan',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris arahan {v} atau lebih baharu; kemas kini VuaOffice.',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan VuaOffice',
    starPromptBody:
      'VuaOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka VuaOffice, beri kami bintang di Vua Office.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke VuaOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'VuaOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit 360 CORP**',
  ...
  he: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם 360 CORP AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון 360 CORP כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountGenspark: 'חשבון 360 CORP',
    account: 'חשבון',
    login: 'התחברות',
    loginGenspark: 'התחברות עם 360 CORP',
    loggedIn: 'מחובר',
    loggedInGenspark: 'מחובר ל-360 CORP',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-360 CORP — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    intgHeroTitle: 'שימוש ב-VuaOffice מתוך עוזר ה-AI שלכם',
    intgHeroDesc:
    ...
    intgStep1Update: 'כשעדכון של VuaOffice מביא skill חדש יותר, ליד אותו עוזר יופיע כפתור עדכון.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'בחרו את תיקיית ה-skills שלו ו-VuaOffice יכתוב שם את הקובץ.',
    ...
    intgExample3: 'המר את budget.xlsx ל-PDF ופתח אותו ב-VuaOffice',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP הוא הפרוטוקול המשותף שבו עוזרי AI קוראים לכלים חיצוניים. השתמשו בו כשהעוזר אינו יכול להריץ פקודות (למשל Claude Desktop) או כשאתם רוצים שהוא ישלוט ישירות בחלון VuaOffice. בחרו אחת משתי הדרכים למטה.',
    intgMcpStdioTitle: 'מופעל על ידי העוזר (מומלץ)',
    intgMcpStdioDesc:
      'העוזר מפעיל את genoffice mcp בעצמו: אין מה להפעיל כאן, ו‑VuaOffice לא חייב להיות פתוח. אותן יכולות כמו ב‑CLI.',
    intgMcpHttpTitle: 'שרת HTTP מקומי',
    intgMcpHttpDesc:
      'פועל בתוך VuaOffice; העוזר מתחבר דרך כתובת URL ואפשר לראות את המסמך נבנה צעד אחר צעד בעורך Word. VuaOffice חייב להישאר פתוח; בשלב זה מסמכי Word בלבד.',
    intgMcpHttpAdvanced: 'מתקדם: כתובות נוספות ויומן',
    intgMcpTryNote: 'העוזר קורא ל‑VuaOffice דרך MCP; אתם לא מקלידים שום פקודה.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'הועתק',
    intgCliEphemeral: 'גררו קודם את VuaOffice לתיקיית היישומים, ואז השתמשו בשורת הפקודה.',
    intgCopyPath: 'העתקת נתיב',
    intgCliNeedsUpdate: 'skill זה דורש שורת פקודה {v} ומעלה; עדכנו את VuaOffice.',
    intgLoading: 'בודק…',
    ...
    onbStarButton: 'פתחו את Vua Office',
    starPromptTitle: 'נהנים מ-VuaOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם VuaOffice',
    starPromptBody: 'VuaOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם VuaOffice מוצא חן בעיניכם, תנו לנו כוכב ב-Vua Office.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-VuaOffice',
    ...
    onbBody2:
      'VuaOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות 360 CORP**',
  ...
  hi: {
    ...
    navCloud: '360 CORP Projects',
    cloudSubtitle:
      '360 CORP AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने 360 CORP खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountGenspark: '360 CORP खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginGenspark: '360 CORP से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInGenspark: '360 CORP में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: '360 CORP से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    intgHeroTitle: 'अपने AI असिस्टेंट से VuaOffice इस्तेमाल करें',
    intgHeroDesc:
    ...
    intgStep1Update:
      'जब VuaOffice के अपडेट में नया skill आता है, तो उस असिस्टेंट के पास अपडेट बटन दिखता है।',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'उसका skills फ़ोल्डर चुनें, VuaOffice वहाँ फ़ाइल लिख देगा।',
    ...
    intgExample3: 'budget.xlsx को PDF में बदलो और VuaOffice में खोलो',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP वह साझा प्रोटोकॉल है जिससे AI सहायक बाहरी टूल बुलाते हैं। इसे तब चुनें जब सहायक कमांड न चला सके (जैसे Claude Desktop) या आप चाहें कि वह VuaOffice की विंडो को सीधे चलाए। नीचे दिए दो तरीकों में से कोई एक चुनें।',
    intgMcpStdioTitle: 'सहायक द्वारा शुरू (अनुशंसित)',
    intgMcpStdioDesc:
      'सहायक खुद genoffice mcp चलाता है: यहाँ कुछ चालू करने की ज़रूरत नहीं, और VuaOffice खुला होना भी ज़रूरी नहीं। सुविधाएँ CLI जैसी ही।',
    intgMcpHttpTitle: 'स्थानीय HTTP सर्वर',
    intgMcpHttpDesc:
      'VuaOffice के अंदर चलता है; सहायक URL से जुड़ता है और आप Word संपादक में दस्तावेज़ को चरण-दर-चरण बनते देख सकते हैं। VuaOffice खुला रहना चाहिए; अभी केवल Word दस्तावेज़।',
    intgMcpHttpAdvanced: 'उन्नत: अन्य पते और लॉग',
    intgMcpTryNote:
      'सहायक MCP के ज़रिये VuaOffice को बुलाता है; आपको कोई कमांड टाइप नहीं करना पड़ता।',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'पहले VuaOffice को Applications में खींचें, फिर कमांड लाइन का उपयोग करें।',
    intgCopyPath: 'पथ कॉपी करें',
    intgCliNeedsUpdate: 'इस skill को कमांड लाइन {v} या नया चाहिए; VuaOffice अपडेट करें।',
    ...
    onbStarButton: 'Vua Office खोलें',
    starPromptTitle: 'VuaOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने VuaOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'VuaOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको VuaOffice पसंद है, तो हमें Vua Office पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'VuaOffice में आपका स्वागत है',
    ...
    onbBody2:
      'VuaOffice अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ 360 CORP क्रेडिट**',
  ...
  'zh-TW': {
    ...
    navStarred: '收藏',
    navCloud: '360 CORP Projects',
    cloudSubtitle: '在網頁端用 360 CORP AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 360 CORP 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountGenspark: '360 CORP 帳號',
    account: '帳號',
    login: '登入',
    loginGenspark: '登入 360 CORP 帳號',
    loggedIn: '已登入',
    loggedInGenspark: '已登入 360 CORP',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 360 CORP，請檢查網路或代理設定',
    ...
    intgHeroTitle: '在 AI 助理中使用 VuaOffice',
    intgHeroDesc:
    ...
    intgStep1Update: 'VuaOffice 升級帶來新版 skill 時，對應助理旁會出現「更新」按鈕。',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: '選擇它的 skills 資料夾，VuaOffice 會把檔案寫進去。',
    ...
    intgExample3: '把 budget.xlsx 轉成 PDF，並在 VuaOffice 中開啟',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP 是 AI 助理呼叫外部工具的通用協定。助理不能執行指令（如 Claude Desktop），或你想讓它直接操作 VuaOffice 視窗時用這條路。下面兩種接法任選一種。',
    intgMcpStdioTitle: '由助理啟動（建議）',
    intgMcpStdioDesc:
      '助理自己啟動 genoffice mcp，不需要在這裡開任何開關，VuaOffice 也不用開著。功能與 CLI 完全相同。',
    intgMcpHttpTitle: '本機 HTTP 服務',
    intgMcpHttpDesc:
      '在 VuaOffice 內執行，助理透過網址連線，可以看著它在 Word 編輯器裡逐步產生。需要 VuaOffice 保持開啟；目前只支援 Word。',
    intgMcpHttpAdvanced: '進階：其他位址與記錄',
    intgMcpTryNote: '助理會透過 MCP 呼叫 VuaOffice，你不需要輸入任何指令。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: '已複製',
    intgCliEphemeral: '請先把 VuaOffice 拖到「應用程式」，再使用命令列。',
    intgCopyPath: '複製路徑',
    intgCliNeedsUpdate: '此 skill 需要命令列 {v} 或更新版本，請更新 VuaOffice。',
    intgLoading: '正在檢查…',
    intgUpdateDue: 'skill 有新版本可更新',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
    ...
    onbStarButton: '開啟 Vua Office',
    starPromptTitle: '喜歡 VuaOffice 嗎？',
    starPromptTitleN: '你已經用 VuaOffice 開啟了 {n} 個文件',
    starPromptBody: 'VuaOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 VuaOffice，歡迎到 Vua Office 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 VuaOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'VuaOffice 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ 360 CORP 點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
  ...
  vi: {
    ...
    aiPanelSideLeft: 'Bên trái',
    aiPanelSideRight: 'Bên phải',
    appMenu: 'Menu',
    conflictBodyMany: 'Thư mục đích đã có {n} mục cùng tên. Bạn muốn xử lý thế nào?',
    conflictBodyOne: 'Thư mục đích đã có «{name}». Bạn muốn xử lý thế nào?',
    conflictKeepBoth: 'Giữ cả hai',
    conflictReplace: 'Thay thế',
    conflictTitle: 'Đã tồn tại mục cùng tên',
    currentFolder: 'Hiện tại',
    deleteFolder: 'Xóa thư mục…',
    deleteFolderConfirm: '«{name}» và toàn bộ nội dung bên trong sẽ được chuyển vào thùng rác.',
    deleteFolderTitle: 'Xóa thư mục?',
    emptyFolder: 'Thư mục này còn trống. Tạo tệp mới hoặc kéo tệp vào đây.',
    folderMoreActions: 'Thao tác khác cho {name}',
    folderType: 'Thư mục',
    folders: 'Thư mục',
    intgCliEphemeral: 'Vui lòng kéo VuaOffice vào thư mục Ứng dụng trước khi sử dụng dòng lệnh.',
    intgCliLauncher: 'Thư mục khởi chạy',
    intgCliNeedsUpdate: 'Skill này yêu cầu dòng lệnh phiên bản {v} hoặc mới hơn. Vui lòng cập nhật VuaOffice.',
    intgCliNotOnPath: 'genoffice {v} · Chưa được thêm vào PATH của terminal. Trợ lý vẫn có thể tìm thấy qua ~/.genoffice/launcher, skill không bị ảnh hưởng. Nếu bạn muốn tự chạy lệnh genoffice trong terminal, chạy một lần:',
    intgCliPartDesc: 'Phù hợp với các trợ lý có thể chạy lệnh terminal (Claude Code, Codex, Cursor...). Sau khi cài đặt skill, trợ lý sẽ tự gọi lệnh genoffice để tạo, chuyển đổi, đọc và chỉnh sửa tệp mà bạn không cần gõ lệnh nào.',
    intgCliPartTitle: 'CLI · Dòng lệnh + skill',
    intgCliReady: 'genoffice {v} · Đã có thể sử dụng trực tiếp trong terminal ({path})',
    intgCliTitle: 'Nâng cao: Dòng lệnh genoffice',
    intgConfirm: 'Xác nhận',
    intgConfirmOverwriteModified: 'Sẽ ghi đè các chỉnh sửa của bạn đối với tệp này.',
    intgConfirmOverwriteOccupied: 'Sẽ thay thế SKILL.md hiện có trong thư mục này.',
    intgConfirmRemove: 'Sẽ xóa: {path}',
    intgConfirmWrite: 'Sẽ ghi vào: {path}',
    intgCopied: 'Đã sao chép',
    intgCopy: 'Sao chép',
    intgCopyPath: 'Sao chép đường dẫn',
    intgDownloadZip: 'Tải xuống skill (zip)',
    intgExample1: 'Chuyển đổi ~/Downloads/report.md thành tài liệu Word',
    intgExample2: 'Tạo bản trình chiếu 6 trang giới thiệu kết quả kinh doanh quý 3',
    intgExample3: 'Chuyển budget.xlsx thành PDF và mở trong VuaOffice',
    intgHeroDesc: 'Sau khi kết nối, các trợ lý như Claude Code, Codex, Cursor, Claude Desktop có thể thay bạn tạo, chuyển đổi, đọc và sửa tài liệu Word, Excel, PowerPoint, PDF và Markdown. Hoàn toàn chạy nội bộ trên máy, không tải dữ liệu lên mạng.',
    intgHeroStep1: 'Chọn cách kết nối: dùng CLI nếu trợ lý chạy được lệnh terminal, dùng MCP nếu không',
    intgHeroStep2: 'Thiết lập theo phần tương ứng bên dưới, thông thường chỉ cần một lần bấm',
    intgHeroStep3: 'Mở cuộc trò chuyện mới và nêu yêu cầu',
    intgHeroTitle: 'Sử dụng VuaOffice trong các trợ lý AI',
    intgInstall: 'Cài đặt',
    intgInstallElsewhere: 'Cài đặt vào thư mục khác…',
    intgInstalledHint: 'Đã cài đặt. Có hiệu lực khi mở phiên làm việc mới.',
    intgLoading: 'Đang kiểm tra…',
    intgMcpClaudeDesc: 'Chạy một lần trong terminal:',
    intgMcpClaudeTitle: 'Claude Code',
    intgMcpHttpAdvanced: 'Nâng cao: Địa chỉ khác và nhật ký',
    intgMcpHttpDesc: 'Chạy bên trong VuaOffice, trợ lý kết nối qua URL để bạn có thể theo dõi tài liệu được tạo trực tiếp từng bước trong trình soạn thảo Word. Yêu cầu giữ VuaOffice mở; hiện hỗ trợ Word.',
    intgMcpHttpTitle: 'Dịch vụ HTTP cục bộ',
    intgMcpNote: 'Skill và MCP có thể cùng tồn tại, trợ lý sẽ tự động lựa chọn; chức năng của cả hai hoàn toàn như nhau.',
    intgMcpOtherDesc: 'Thêm đoạn này vào cấu hình MCP server (tệp JSON hoặc phần Thêm MCP Server trong cài đặt):',
    intgMcpOtherTitle: 'Cursor, Claude Desktop hoặc các trợ lý hỗ trợ MCP khác',
    intgMcpPartDesc: 'MCP là giao thức chuẩn để trợ lý AI gọi các công cụ bên ngoài. Sử dụng khi trợ lý không thể chạy lệnh (như Claude Desktop) hoặc khi bạn muốn thao tác trực tiếp với cửa sổ VuaOffice.',
    intgMcpPartTitle: 'MCP',
    intgMcpStdioDesc: 'Trợ lý tự khởi chạy genoffice mcp, không cần bật công tắc nào ở đây và không cần mở sẵn VuaOffice. Chức năng tương đương CLI.',
    intgMcpStdioTitle: 'Trợ lý tự khởi động (Khuyến nghị)',
    intgMcpTryNote: 'Trợ lý sẽ gọi VuaOffice qua MCP, bạn không cần nhập lệnh thủ công.',
    intgOtherDesc: 'Chọn một trong ba cách bên dưới. Tất cả đều cài cùng một skill, không cần thao tác trùng lặp.',
    intgOtherFolderDesc: 'Chọn thư mục skills của trợ lý, VuaOffice sẽ ghi tệp vào đó.',
    intgOtherFolderTitle: 'Mọi trợ lý có thể đọc thư mục SKILL.md',
    intgOtherNpxDesc: 'Chạy trong terminal:',
    intgOtherNpxTitle: 'Cài đặt bằng lệnh skills (yêu cầu Node.js)',
    intgOtherToggle: 'Không thấy trợ lý của tôi',
    intgOtherZipDesc: 'Lưu skill thành tệp zip để trợ lý tự cài đặt.',
    intgOtherZipTitle: 'Gửi tệp cho trợ lý',
    intgOverwrite: 'Ghi đè',
    intgPickDirTitle: 'Chọn thư mục skills',
    intgReinstall: 'Cài đặt lại thành {v}',
    intgSaveZipTitle: 'Lưu skill',
    intgSavedTo: 'Đã lưu vào {path}',
    intgSkillVersion: 'skill {v}',
    intgStateForeign: 'Đã cài đặt {v} (bởi nguồn khác)',
    intgStateInstalled: 'Đã cài đặt skill {v} · Sẵn sàng dùng ở lượt trò chuyện kế tiếp',
    intgStateMissing: 'Chưa cài đặt skill',
    intgStateModified: 'Đã cài đặt {v} (đã bị chỉnh sửa)',
    intgStateNewer: 'Đã cài đặt {v} (mới hơn phiên bản đi kèm ứng dụng)',
    intgStateOccupied: 'Thư mục đã bị chiếm dụng',
    intgStateOutdated: 'Đã cài đặt {v}, có thể cập nhật lên {next}',
    intgStep1Desc: 'Danh sách các trợ lý phát hiện được trên máy. Chỉ cần cài cho trợ lý bạn thực sự sử dụng.',
    intgStep1Title: 'Cài đặt skill vào trợ lý của bạn',
    intgStep1Update: 'Khi VuaOffice phát hành phiên bản skill mới, nút Cập nhật sẽ xuất hiện cạnh trợ lý tương ứng.',
    intgStep2Desc: 'Mở hội thoại mới trong trợ lý và nêu yêu cầu như thường ngày, ví dụ:',
    intgStep2DescBefore: 'Sau khi cài đặt, mở hội thoại mới và nêu yêu cầu tự nhiên, ví dụ:',
    intgStep2Note: 'Trợ lý sẽ tự gọi dòng lệnh genoffice, bạn không cần gõ lệnh nào.',
    intgStep2Title: 'Thử nghiệm',
    intgUninstall: 'Gỡ cài đặt',
    intgUpdate: 'Cập nhật',
    intgUpdateDue: 'Có phiên bản skill mới cần cập nhật',
    itemCount: '{n} mục',
    itemCountOne: '{n} mục',
    moveCount: 'Di chuyển {n} mục',
    ...
    pickSaveDir: 'Chọn lại vị trí lưu',
    removeFolderRoot: 'Xóa khỏi danh sách',
    rootUnavailable: 'Không khả dụng',
    rootUnusable: 'Vị trí lưu mặc định không khả dụng, không thể hiển thị thư mục.',
    ...
    searchJevSettings: 'Sắp xếp ngữ nghĩa Jev',
    searchNoResults: 'Không tìm thấy tệp khớp với «{q}»',
    searchRerankedBy: 'Đã được Jev sắp xếp lại theo mức độ liên quan',
    searchResultCount: '{n} kết quả',
    searchResultCountOne: '{n} kết quả',
    setAiCapFileSearch: 'Tìm kiếm tệp trên máy',
    setAiPanelSide: 'Vị trí thanh bên AI',
    setAiSearchParallelHint: 'Để trống API key để dùng miễn phí tìm kiếm Parallel (giới hạn lượt dùng). Nhập key để dùng tài khoản Parallel của bạn. Tìm kiếm hình ảnh sử dụng nguồn khác.',
    setMcp: 'Dịch vụ MCP cục bộ',
    setMcpBg: 'Tạo tài liệu ngầm',
    setMcpBgDesc: 'Cho phép tạo tài liệu trực tiếp vào vị trí chỉ định mà không mở giao diện; khi tắt sẽ tạo trực tiếp hiển thị trên màn hình.',
    setMcpConfig: 'Mẫu cấu hình client',
    setMcpConfigDesc: 'Thêm vào cấu hình MCP server của client (như mcp.json của Claude Desktop hoặc MCP Settings của Cursor).',
    setMcpConn: 'Thông tin kết nối',
    setMcpCopied: 'Đã sao chép',
    setMcpCopy: 'Sao chép',
    setMcpDesc: 'Cho phép trợ lý AI bên ngoài (như Claude Desktop, Cursor) tạo tài liệu Word qua ứng dụng này. Chỉ truy cập cục bộ.',
    setMcpHealth: 'Kiểm tra trạng thái',
    setMcpLog: 'Nhật ký',
    setMcpLogClear: 'Xóa',
    setMcpLogDesc: 'Ghi nhật ký dịch vụ MCP và các lệnh gọi công cụ, lưu vào tệp nhật ký cục bộ',
    setMcpLogEmpty: 'Chưa có nhật ký',
    setMcpLogFile: 'Tệp nhật ký',
    setMcpLogOpen: 'Mở',
    setMcpLogRefresh: 'Làm mới',
    setMcpPort: 'Cổng',
    setMcpRunning: 'Đang chạy',
    setMcpStopped: 'Đã dừng',
    setMcpUrlHttp: 'Streamable HTTP (Khuyến nghị)',
    setMcpUrlSse: 'SSE (Client cũ)',
    setSearchRerank: 'Sắp xếp lại kết quả tìm kiếm Jev',
    setSearchRerankDesc: 'Gửi 20 đoạn kết quả đầu tiên đến mô hình Jev của TypeSafe để sắp xếp lại theo độ liên quan. Mặc định tắt; khi bật dữ liệu trích đoạn sẽ gửi đi để xếp hạng.',
    ...
    navCloud: 'Dự án 360 CORP',
    cloudSubtitle:
      'Các dự án được tạo trên web với AI 360 CORP. Tiếp tục chỉnh sửa trên trình duyệt — nhấp vào dự án bất kỳ để mở.',
    cloudSearchPlaceholder: 'Tìm kiếm {n} dự án…',
    cloudNoResults: 'Không tìm thấy dự án phù hợp.',
    cloudGroupThisWeek: 'Tuần này',
    cloudGroupThisMonth: 'Trước đó trong tháng',
    cloudSortLabel: 'Sắp xếp: {v}',
    cloudSortRecent: 'Mới nhất',
    cloudSortOldest: 'Cũ nhất',
    cloudRefresh: 'Làm mới',
    cloudLoginHint: 'Đăng nhập tài khoản 360 CORP để xem các dự án bạn đã tạo trên web.',
    cloudEmpty: 'Chưa có dự án nào trên web.',
    cloudError: 'Tải thất bại. Vui lòng thử lại sau.',
    cloudRetry: 'Thử lại',
    cloudLoadMore: 'Tải thêm',
    cloudOpenInBrowser: 'Mở trong trình duyệt',
    navTrash: 'Thùng rác',
    navTrashTip: 'Tệp đã xóa nằm trong Thùng rác hệ thống và có thể khôi phục từ đó',
    ...
    greetAsk1: 'Hôm nay bạn muốn tạo tài liệu gì?',
    greetAsk2: 'Sẵn sàng bắt đầu chưa?',
    greetAsk3: 'Bạn đang xử lý công việc gì?',
    greetAsk4: 'Chúng ta bắt đầu từ đâu hôm nay?',
    greetAsk5: 'Bạn có ý tưởng mới nào không?',
    greetAsk6: 'Bạn đang nghĩ về điều gì tiếp theo?',
    // Bộ lọc
    filterAll: 'Tất cả',
    filterDocs: 'Văn bản',
    filterSheets: 'Bảng tính',
    filterSlides: 'Trình chiếu',
    filterPdf: 'PDF',
    filterMd: 'Markdown',
    filterHtml: 'HTML',
    filterAria: 'Lọc theo loại tệp',
    // Danh sách / Thao tác hàng loạt
    fileCount: '{n} tệp',
    fileCountOne: '{n} tệp',
    ...
    moveToProject: 'Di chuyển vào dự án',
    rename: 'Đổi tên',
    duplicate: 'Tạo bản sao',
    renameFailed: 'Đổi tên thất bại',
    emptyStarred: 'Chưa có tệp gắn sao — di chuột vào hàng tệp và bấm vào ngôi sao.',
    emptyRecent: 'Chưa có tệp gần đây — tạo mới hoặc mở một tệp để bắt đầu.',
    ...
    deleteMoreCount: '… tổng cộng {n} tệp',
    delete: 'Xóa',
    // Bảng dự án bên
    projects: 'Dự án',
    ...
    noContent: '(trống)',
    // Tài khoản
    accountGenspark: 'Tài khoản 360 CORP',
    account: 'Tài khoản',
    login: 'Đăng nhập',
    loginGenspark: 'Đăng nhập với 360 CORP',
    loggedIn: 'Đã đăng nhập',
    loggedInGenspark: 'Đã đăng nhập 360 CORP',
    waitingLogin: 'Đang đợi đăng nhập trên trình duyệt… Nhấp để mở lại trang đăng nhập',
    waitingShort: 'Đang đợi…',
    loginTimeout: 'Hết thời gian đăng nhập — nhấp để thử lại',
    loginLaunchFailed: 'Không thể khởi chạy đăng nhập — nhấp để thử lại',
    loginOpenManually: 'Trình duyệt không tự mở? Nhấp để mở thủ công',
    loginOpenShort: 'Mở trang đăng nhập thủ công',
    loginCopyUrl: 'Sao chép liên kết đăng nhập',
    loginCopied: 'Đã sao chép',
    loginNetworkError: 'Không thể kết nối 360 CORP — kiểm tra lại mạng hoặc proxy',
    loginExpired: 'Phiên đăng nhập đã hết hạn — nhấp để thử lại',
    loginFailed: 'Đăng nhập thất bại — nhấp để thử lại',
    loggingOut: 'Đang đăng xuất…',
    logout: 'Đăng xuất',
    credits: 'Điểm sử dụng AI',
    creditsTip: 'Xem chi tiết lượt dùng AI',
    appVersion: 'Phiên bản {v}',
    versionLabel: 'Phiên bản',
    updateChannel: 'Kênh cập nhật',
    channelStable: 'Bản ổn định',
    channelBeta: 'Bản Beta',
    theme: 'Giao diện',
    themeLight: 'Sáng',
    themeDark: 'Tối',
    themeSystem: 'Theo hệ thống',
    saveLocation: 'Vị trí lưu mặc định',
    setAutoSave: 'Tự động lưu mọi tài liệu',
    setAutoSaveDesc:
      'Bật Tự động lưu mặc định trong mọi trình soạn thảo. Bạn vẫn có thể tắt riêng cho từng cửa sổ.',
    setAnalytics: 'Gửi thống kê sử dụng ẩn danh',
    setAnalyticsDesc:
      'Tính năng này được bật mặc định và có thể tắt bất cứ lúc nào trong Cài đặt → Chung. Sử dụng Google Analytics 4; Google nhận địa chỉ IP công khai và siêu dữ liệu truyền tải của bạn, nhưng tuyệt đối không thu thập nội dung tài liệu hoặc tên tệp.',
    setAiFontSize: 'Cỡ chữ bảng AI',
    ...
    setAiSpellcheckDesc: 'Gạch chân từ sai chính tả khi nhập vào ô trò chuyện AI.',
    settings: 'Cài đặt',
    ...
    setAiApiKey: 'API Key',
    setAiKeyHint: 'Chỉ lưu trữ trên thiết bị này.',
    setAiBaseUrl: 'Base URL',
    setAiBaseUrlHint: 'Để trống để sử dụng điểm cuối chính thức.',
    setAiGensparkHint: 'Sử dụng đăng nhập Genspark; không cần API key.',
    setAiCodexPath: 'Tệp thực thi Codex',
    setAiCodexPathHint:
      'Chỉ đặt giá trị này khi cài đặt tùy chỉnh; để trống để tự động dò tìm.',
    setAiCodexAutoPlaceholder: 'Tự động dò tìm (khuyến nghị)',
    setAiCodexHint:
      'Tự động tìm Codex CLI đang đăng nhập sau khi cập nhật; đường dẫn tùy chỉnh là không bắt buộc. Không cần API key.',
    setAiByokNote:
      'Trò chuyện sử dụng key của riêng bạn; các công cụ đám mây (tìm kiếm web, tạo ảnh) vẫn cần đăng nhập Genspark.',
    setAiSave: 'Lưu',
    setAiSaved: 'Đã lưu',
    ...
    setSecAiMedia: 'Phương tiện & Tìm kiếm AI',
    setAiMediaGensparkHint:
      'Tạo ảnh và phân tích ảnh/video sử dụng đăng nhập Genspark của bạn.',
    setAiImageModel: 'Mô hình tạo ảnh',
    setAiAnalysisModel: 'Mô hình phân tích',
    setAiSearchGensparkHint:
      'Tìm kiếm web và ảnh sử dụng đăng nhập Genspark của bạn; khi đăng xuất hoặc tắt công cụ đám mây, chúng chuyển sang nguồn miễn phí.',
    setAiSearchSerperHint: 'Serper phục vụ cả tìm kiếm web và ảnh bằng key của bạn.',
    setAiSearchTavilyHint:
      'Tavily phục vụ tìm kiếm web bằng key của bạn; tìm kiếm ảnh chuyển sang nguồn miễn phí.',
    setAiCapImage: 'Tạo ảnh',
    setAiCapAnalysis: 'Phân tích ảnh',
    setAiCapVideo: 'Phân tích video',
    setAiCapSearch: 'Tìm kiếm web',
    setAiSharedKeyHint:
      'Key và Base URL của một nhà cung cấp được dùng chung cho mọi khả năng; chỉ cần nhập một lần.',
    ...
    starOnGitHub: 'Tặng sao trên GitHub',
    onbStarButton: 'Mở Vua Office',
    starPromptTitle: 'Bạn thích VuaOffice chứ?',
    starPromptTitleN: 'Bạn đã mở {n} tài liệu với VuaOffice',
    starPromptBody:
      'VuaOffice là phần mềm nguồn mở và miễn phí. Tặng một ngôi sao trên GitHub là cách tuyệt vời nhất để ủng hộ đội ngũ phát triển.',
    starPromptGo: 'Tặng sao trên GitHub',
    starPromptDone: 'Đã tặng sao',
    starPromptLater: 'Để sau',
    onbStarHint: 'Nếu bạn yêu thích VuaOffice, hãy tặng chúng tôi một ngôi sao trên Vua Office.',
    setEmail: 'Email',
    ...
    newTab: 'Tab mới',
    // Giới thiệu lần đầu chạy
    onbTitle1: 'Chào mừng đến với VuaOffice',
    onbSubtitle1: 'Bộ ứng dụng văn phòng AI-Native Tất cả trong Một Miễn phí đầu tiên',
    onbBody1:
      'Soạn thảo tài liệu, xử lý bảng tính, thiết kế trình chiếu, đọc Markdown, xử lý Email và duyệt PDF. AI tích hợp sâu trong mọi quy trình.',
    onbTitle2: 'Đây chỉ mới là sự khởi đầu',
    onbBody2:
      'VuaOffice hiện đang trong giai đoạn phát triển. Hãy tham gia nhóm trò chuyện trên GenTeam để chia sẻ đóng góp và cùng nhau định hình tương lai.',
    onbCredits: 'Người đóng góp tích cực nhận được **1,000+ điểm thưởng AI 360 CORP**',
    onbJoinGenTeam: 'Tham gia GenTeam',
    onbSkip: 'Bỏ qua',
    onbNext: 'Tiếp theo',
    onbStart: 'Bắt đầu ngay',
    onbStepAria: 'Trang {n} / {total}',
    onbTitle3: 'Miễn phí cho tất cả mọi người',
    onbBody3: 'Không phí bản quyền. Không quảng cáo. Không gắn watermark.',
    onbNote3: 'Các tính năng AI nâng cao có thể tiêu hao điểm thưởng AI 360 CORP.',
    onbBack: 'Quay lại',
